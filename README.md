...
```
### The public key id_rsa.pub must be copied into same directory with Terrform directory
...
![Admin](./Pic/3.PNG)
## Generate the RSA key for Jenkins user. This key is used by BastionHost Jenkins, managing the k8s cluster
```
sudo -i
su - jenkins
ssh-keygen
